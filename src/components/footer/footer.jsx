...
function Footer() {
    return (
        ...
        <Link className='footer_link' to={'/plan'}>
        Create Your Plan
        </Link>
        </ul>
        
        <div className='footer_img-wrapper'>
        <svg className='footer_each-img'  width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className='footer_each-img' width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
